...
enum {
	...
	KEY_FM_RADIO,
	KEY_WILD_ANY_CCITT,          // Any CCITT key, i. e. 0 thru 9, + # or *
	KEY_GENERIC,
	KEY_LONG,
	KEY_CARKIT1,
	KEY_CARKIT2,
	...
	// 60
	KEY_CARKIT3,
	KEY_JOY_OK,                  // Joystick center key for 5-way navigation
	KEY_ACC_POWER,
	KEY_CAM,                     // Dedicated camera key
	KEY_PTT,                     // Push-To Talk switch key
	KEY_HIGH_AUDIO,
	KEY_CARRIER_1,
	KEY_CARRIER_2,
	KEY_VIDEO_CALL,
...
/* Masks of variable keys for handle DL_KeyKjavaGetKeyState() function result
 * for example: DL_KeyKjavaGetKeyState() & MULTIKEY_STAR check star "*" key is pressed
 */
